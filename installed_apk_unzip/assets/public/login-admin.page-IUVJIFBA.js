...
var _LoginAdminPage = class _LoginAdminPage {
  constructor() {
    ...
    this.shieldIcon = shieldCheckmarkOutline;
  ...
  ingresar() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const credencial = yield this.loginAdminSeguro(usuarioIngresado, password);
        ...
        this.cargando = false;
        yield this.irPanelAdministrador();
      } catch (error) {
  ...
  loginAdminSeguro(usuarioIngresado, password) {
    return __async(this, null, function* () {
      const correoDirecto = this.resolverCorreoAuth(usuarioIngresado);
      try {
        return yield this.authService.login(correoDirecto, password);
      } catch (errorDirecto) {
        console.warn("[LoginAdminPage] Fall\xF3 login directo. Intentando Firestore como respaldo:", errorDirecto);
      }
  ...
  buscarUsuarioSinRomper(usuarioIngresado) {
    return __async(this, null, function* () {
      try {
        ...
        console.warn("[LoginAdminPage] Firestore no permiti\xF3 buscar usuario antes del login:", error);
        return null;
      }
    });
  }
    ...
    return __async(this, null, function* () {
      ...
      for (const correo of correos) {
        ...
        try {
          ...
          console.error("[LoginAdminPage] Fall\xF3 login con:", correo, error);
          ultimoError = error;
        }
      }
      throw ultimoError || new Error("login-fallido");
  ...
  irPanelAdministrador() {
    return __async(this, null, function* () {
      console.log("[LoginAdminPage] Login correcto. Abriendo /dashboard-admin...");
      yield this.navCtrl.navigateRoot("/dashboard-admin", {
        animated: false,
        replaceUrl: true
      });
    });
...
_LoginAdminPage.\u0275fac = function LoginAdminPage_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _LoginAdminPage)();
};
_LoginAdminPage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginAdminPage, selectors: [["app-login-admin"]], decls: 44, vars: 19, consts: [[1, "login-rol-root", 3, "fullscreen"], [1, "login-wrapper"], ["type", "button", 1, "btn-volver", 3, "click", "disabled"], [3, "icon"], [1, "login-header"], ["src", "assets/img/logo.png", "alt", "Logo Comproy", 1, "logo-img"], [1, "empresa-nombre"], [1, "empresa-subtitulo"], [1, "login-card"], [1, "rol-icon", "admin"], [3, "ngSubmit", "formGroup"], [1, "campo-bloque"], [1, "campo-caja"], ["type", "text", "formControlName", "usuario", "placeholder", "Ingrese su usuario", "autocomplete", "username", 3, "disabled"], ["formControlName", "password", "placeholder", "Ingrese su contrase\xF1a", "autocomplete", "current-password", 3, "type", "disabled"], ["type", "button", 1, "btn-ojo", 3, "click", "disabled"], [1, "login-opciones"], [1, "recordarme-label"], ["formControlName", "recordarme"], ["type", "button", 1, "btn-link", 3, "click", "disabled"], ["type", "button", 1, "btn-ingresar", "admin", 3, "click", "disabled"]], template: function LoginAdminPage_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-content", 0)(1, "main", 1)(2, "button", 2);
    \u0275\u0275listener("click", function LoginAdminPage_Template_button_click_2_listener() {
      return ctx.volver();
    });
    ...
    \u0275\u0275text(12, " Acceso administrativo ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(13, "section", 8)(14, "div", 9);
    \u0275\u0275element(15, "ion-icon", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "h2");
    \u0275\u0275text(17, "Administrador");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "p");
    \u0275\u0275text(19, "Ingrese su usuario administrador para acceder al panel de gesti\xF3n.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "form", 10);
    \u0275\u0275listener("ngSubmit", function LoginAdminPage_Template_form_ngSubmit_20_listener() {
      return ctx.ingresar();
    });
    \u0275\u0275elementStart(21, "div", 11)(22, "label");
    \u0275\u0275text(23, "Usuario administrador");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LoginAdminPage_Template_button_click_33_listener() {
    ...
    \u0275\u0275listener("click", function LoginAdminPage_Template_button_click_40_listener() {
      return ctx.recuperarContrasena();
    });
    \u0275\u0275text(41, " \xBFOlvidaste tu contrase\xF1a? ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "button", 20);
    \u0275\u0275listener("click", function LoginAdminPage_Template_button_click_42_listener() {
      return ctx.ingresar();
    });
    \u0275\u0275text(43);
    \u0275\u0275elementEnd()()()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(12);
    \u0275\u0275property("icon", ctx.shieldIcon);
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx.cargando ? "Ingresando..." : "Ingresar como administrador", " ");
  }
}, dependencies: [
  CommonModule,
  ReactiveFormsModule,
...
<ion-icon [icon]="arrowBackIcon"></ion-icon>
    ...
    <section class="login-card">
      ...
      <h2>Administrador</h2>
      <p>Ingrese su usuario administrador para acceder al panel de gesti\xF3n.</p>
        ...
        <div class="campo-bloque">
          ...
          >
            ...
            <button
              ...
              [disabled]="cargando"
            >
<ion-icon [icon]="mostrarPassword ? eyeOffIcon : eyeIcon"></ion-icon>            </button>
          </div>
        </div>
       ...
       <button
  type="button"
  class="btn-ingresar admin"
  (click)="ingresar()"
  [disabled]="formulario.invalid || cargando"
>
          {{ cargando ? 'Ingresando...' : 'Ingresar como administrador' }}
        </button>
...
</ion-content>`, styles: ["/* src/app/paginas/auth/login-admin/login-admin.page.css */\nion-content.login-root,\nion-content.login-rol-root {\n  --background: #f5f7fa;\n}\n.login-wrapper {\n  min-height: 100vh;\n  max-width: 430px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  padding: 32px 20px 40px;\n  background: #f5f7fa;\n  box-sizing: border-box;\n  position: relative;\n}\n.btn-volver {\n  position: absolute;\n  top: 18px;\n  left: 18px;\n  border: none;\n  background: transparent;\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  color: #1a3e8c;\n  font-size: 13px;\n  font-weight: 700;\n  cursor: pointer;\n}\n.btn-volver ion-icon {\n  font-size: 20px;\n}\n.login-header {\n  width: 100%;\n  max-width: 380px;\n  margin-bottom: 20px;\n  display: flex;\n  justify-content: center;\n}\n.header-logo-area,\n.login-header {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.logo-img {\n  width: 56px;\n  height: 56px;\n  object-fit: contain;\n}\n.header-texto,\n.login-header div {\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.empresa-nombre {\n  font-size: 16px;\n  font-weight: 700;\n  color: #101828;\n}\n.empresa-subtitulo {\n  font-size: 11px;\n  color: #667085;\n}\n.login-card {\n  width: 100%;\n  max-width: 380px;\n  background: #ffffff;\n  border-radius: 16px;\n  padding: 28px 24px;\n  box-shadow: 0 1px 3px rgba(16, 24, 40, 0.08), 0 4px 16px rgba(16, 24, 40, 0.06);\n  box-sizing: border-box;\n}\n.rol-icon {\n  display: none;\n}\n.card-titulo,\n.login-card h2 {\n  font-size: 22px;\n  font-weight: 700;\n  text-align: center;\n  color: #101828;\n  margin: 0;\n}\n.card-descripcion,\n.login-card p {\n  font-size: 13px;\n  color: #667085;\n  text-align: center;\n  margin: 8px 0 24px;\n  line-height: 1.45;\n}\n.campo-bloque {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n  margin-bottom: 16px;\n}\n.campo-etiqueta,\n.campo-bloque label {\n  font-size: 13px;\n  font-weight: 500;\n  color: #101828;\n}\n.campo-caja {\n  display: flex;\n  align-items: center;\n  border: 1px solid #d0d5dd;\n  border-radius: 10px;\n  height: 44px;\n  padding: 0 12px;\n  background: #ffffff;\n  box-sizing: border-box;\n}\n.campo-caja:focus-within {\n  border-color: #1a3e8c;\n  box-shadow: 0 0 0 3px rgba(26, 62, 140, 0.12);\n}\n.campo-caja.error {\n  border-color: #d92d20;\n}\n.campo-caja.error:focus-within {\n  box-shadow: 0 0 0 3px rgba(217, 45, 32, 0.12);\n}\n.campo-icono-iz,\n.campo-caja ion-icon {\n  font-size: 18px;\n  color: #667085;\n  margin-right: 10px;\n  flex-shrink: 0;\n}\n.campo-input,\n.campo-caja input {\n  flex: 1;\n  width: 100%;\n  border: none;\n  outline: none;\n  font-size: 14px;\n  color: #101828;\n  background: transparent;\n  height: 100%;\n}\n.btn-ojo {\n  background: none;\n  border: none;\n  padding-left: 8px;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n}\n.btn-ojo ion-icon {\n  font-size: 18px;\n  color: #667085;\n  margin: 0;\n}\n.login-opciones {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  gap: 12px;\n  margin-bottom: 24px;\n}\n.recordarme-label {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 13px;\n  color: #101828;\n  cursor: pointer;\n}\n.recordarme-label ion-checkbox,\n.recordarme-label ion-checkbox.checkbox-custom {\n  --size: 16px;\n  --checkbox-background-checked: #1a3e8c;\n  --border-color: #d0d5dd;\n  --border-radius: 4px;\n}\n.btn-olvide,\n.btn-link {\n  background: none;\n  border: none;\n  padding: 0;\n  font-size: 13px;\n  color: #1a3e8c;\n  font-weight: 500;\n  cursor: pointer;\n}\n.btn-ingresar {\n  width: 100%;\n  height: 48px;\n  background: #1a3e8c;\n  color: #ffffff;\n  border: none;\n  border-radius: 10px;\n  font-size: 15px;\n  font-weight: 600;\n  cursor: pointer;\n}\n.btn-ingresar:hover:not(:disabled) {\n  background: #15337a;\n}\n.btn-ingresar:active:not(:disabled) {\n  transform: scale(0.98);\n}\n.btn-ingresar:disabled,\nbutton:disabled {\n  opacity: 0.55;\n  cursor: not-allowed;\n}\n.card-pie {\n  text-align: center;\n  font-size: 13px;\n  color: #667085;\n  margin-top: 18px;\n}\n.link-contacto {\n  color: #1a3e8c;\n  font-weight: 500;\n  cursor: pointer;\n}\n@media (max-height: 720px) {\n  .login-wrapper {\n    justify-content: flex-start;\n    padding-top: calc(58px + env(safe-area-inset-top));\n  }\n  .login-header {\n    margin-bottom: 14px;\n  }\n  .login-card {\n    padding-top: 22px;\n    padding-bottom: 22px;\n  }\n}\n@media (max-width: 360px) {\n  .login-wrapper {\n    padding-left: 14px;\n    padding-right: 14px;\n  }\n  .login-opciones {\n    gap: 8px;\n  }\n  .btn-link,\n  .recordarme-label {\n    font-size: 12px;\n  }\n}\n/*# sourceMappingURL=login-admin.page.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginAdminPage, { className: "LoginAdminPage", filePath: "src/app/paginas/auth/login-admin/login-admin.page.ts", lineNumber: 38 });
})();
export {
  LoginAdminPage
};
//# sourceMappingURL=login-admin.page-IUVJIFBA.js.map
